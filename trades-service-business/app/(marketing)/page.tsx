...
// Dynamically set favicon and theme color based on business config
const updateDocumentHead = () => {
  ...
  // Optional: Set favicon dynamically if you have business-specific favicons
  // const link = document.querySelector("link[rel*='icon']") || document.createElement('link');
  // link.rel = 'shortcut icon';
  // link.href = `/favicons/${BUSINESS_CONFIG.type}-favicon.ico`;
...
export default function Home() {
  ...
  // Capitalize business type for display (e.g., "plumbing" → "Plumbing")
      ...
      <div className="container mx-auto px-4 py-6 max-w-6xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
          ...
          <div className="lg:sticky lg:top-8">
            ...
            {/* Emergency Contact Banner (for urgent services like plumbing/electrical) */}
